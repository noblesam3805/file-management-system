...
echo "<select onchange='filter_staff(this.value);' onclick='filter_staff(this.value);'  id='dept_code'  name='dept_code' class='form-control eduportal-input' style='width: 300px' required>";
