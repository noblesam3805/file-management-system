       ...
       <div id="left" >
            <div class="media user-media well-small">
                <a class="user-link" href="#">
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="../assets/img/human-icon-png-1901.png" />
                </a>
                <br />
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                        <i class="icon-tasks"> </i> Admin Menu
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <li class=""><a href="register.php"><i class="icon-angle-right"></i> Create Admin </a></li>
                        <li class=""><a href="list.php?data=admin"><i class="icon-angle-right"></i> List Admin </a></li>
                         <li class=""><a href="fraud.php"><i class="icon-angle-right"></i> Fraud Notice </a></li>
                        <li class=""><a href="block.php"><i class="icon-angle-right"></i> Block Account </a></li>
						 <li class=""><a href="list.php?data=customers"><i class="icon-angle-right"></i> List Customers </a></li>
						  <li class=""><a href="../iBankingBiometrics.exe"  ><i class="icon-angle-right"></i> Create Customers </a></li>
