jQuery(document).ready(function() {
    ...
    var piedata = [
        ...
        { label: "Series 4", data: [[1,70]], color: '#1FB5AD'},
   ...
   var m1 = new Morris.Line({
    ...
    var m6 = new Morris.Donut({
        ...
        colors: ['#D9534F','#1CAF9A','#1FB5AD','#5BC0DE','#1FB5AD']
    });
    ...
    jQuery('#sparkline3').sparkline([4,3,3,1,4,3,2,2,3], {
		  type: 'pie', 
		  height:'33px',
        sliceColors: ['#F0AD4E','#1FB5AD','#D9534F','#1CAF9A','#5BC0DE']
    });
