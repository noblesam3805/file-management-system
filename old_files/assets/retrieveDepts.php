...
?>
<select  name="depts" id="depts" class="form-select required" onChange="javascript: populateDepartmentsOptions(this.value,programme.value); "><option value="" selected="selected" >- Select Department -</option>
