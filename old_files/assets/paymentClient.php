...
$responseurl = 'http://www.alvanportal.edu.ng/eduportal/assets/check.php';
...
if ($success == null){ //or success = "" for php
	...
	echo "<input type='hidden' name = 'RESPONSE_URL' value='http://www.alvanportal.edu.ng/eduportal/assets/check.php'>";
	echo "<input type='hidden' name = 'CHECKSUM' value='".$checksum."'>"; 
	echo "<input type=hidden name = 'ECHODATA' value='<customerinfo><firstname>Emmanuel</firstname><lastname>Etti</lastname><phoneno>08131342381</phoneno><email>etti.emman@gmail.com</email><address></address><city></city><state></state><zipcode></zipcode><postcode></postcode><country></country><otherdetails></otherdetails></customerinfo>'>";
