...
<?php
	...
	function processRemitaSchoolFeeInvoice($rrr)
	{
		session_start();
if(!$rrr)
{
...
//$responseurl = "https://www.ebsu.edu.ng/portal/RemitaGatewaySCHF.php";
$responseurl = "https://iportal.ebsu.edu.ng/portal/RemitaGatewaySCHF.php";
	//	$responseurl = "http://104.217.252.100/portal/RemitaGateway.php";
...
<input id="payerPhone" name="payerPhone" value="<?php echo $payerPhone; ?>" type="hidden"/>
<input id="orderId" name="orderId" value="<?php echo $orderID; ?>" type="hidden"/>
<input id="customFields" name="customFields[]" value="{
            'name':'Matric Number',
            'value':'1509329285795',
            'type':'ALL'
         }" type="hidden"/>
...
$invoice_data = array(
			   ...
			   'email' => $email,
			   'dept_id' => $studentDetails->dept,
			   'fee_description'=>'EBSU SCHOOL FEE - '.$year,
			   'level'=>$year,
			   'semester'=>$semester
