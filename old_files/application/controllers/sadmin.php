...
if($check_dup>0)
						...
						$pass=mt_rand(1000,20000);
									sqlsrv_query($conn,"insert into sadmin (name,email,reg_no,password,permissions,level,dept_id,phone) values ('$name','$email','$email','$pass','1','$role','$depts','$phone')") or  die(print_r( sqlsrv_errors(), true));
...
<td>Login at http://portal.YABATECH.edu.ng/nekede</td>
</tr>
</table>
</body>
</html>
...
$page_data['db2']  = $db2;
	...
	if($checkSession<2019 && $academic_session=='2018/2019'){
  ...
  $table_columns = array("S/N","Matric.No/Application No.", "Name", "RRR No.","Session","Amount", "Payment Name", "Description", "Department", "Payment Date","Level");  	 		 	 		
  ...
  foreach($table_columns as $field)
  {
   ...
   $column++;
		...
		$payments= $this->db->query("SELECT * FROM applicationinvoice_gen WHERE  status='Approved'
	  ...
	  foreach($payments as $row)
  {
   ...
   $object->getActiveSheet()->setCellValueByColumnAndRow(1, $excel_row, $row['payerID']);
   $object->getActiveSheet()->setCellValueByColumnAndRow(2, $excel_row, $row['payername']);
   $object->getActiveSheet()->setCellValueByColumnAndRow(3, $excel_row, $row['rrr']);
   $object->getActiveSheet()->setCellValueByColumnAndRow(4, $excel_row, $row['acadsession']);
   $object->getActiveSheet()->setCellValueByColumnAndRow(5, $excel_row,$row['amt']);
   $object->getActiveSheet()->setCellValueByColumnAndRow(6, $excel_row, $row['paymentName']);	
   $object->getActiveSheet()->setCellValueByColumnAndRow(7, $excel_row,$row['paymentdescription']);
   $object->getActiveSheet()->setCellValueByColumnAndRow(8, $excel_row, $row['programName']); 
   $object->getActiveSheet()->setCellValueByColumnAndRow(9, $excel_row, $row['dategenerated']);
     if($regNoCheck1==8 || $regNoCheck1==9){
	   $object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND I');
							...
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND I');
								...
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND I');	
							...
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND I');	
								...
								if($regNoCheck3=='F/ND/17'){
										$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND II');	
							...
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND I');	
								...
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND II');	
							...
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND II');	
									...
									if($regNoCheck3=='P/HD/16' || $regNoCheck3=='P/HD/15' || $regNoCheck3=='P/HD/14'){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND III');	
									
								}
								if($regNoCheck3=='P/ND/15' || $regNoCheck3=='P/ND/16'|| $regNoCheck3=='P/ND/14' ){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND III');	
  ...
  header('Content-Disposition: attachment;filename="All FullTime school fees.xls"');
...
exit();		
  ...
  $object_writer = PHPExcel_IOFactory::createWriter($object, 'Excel5');
  header('Content-Type: application/vnd.ms-excel');
  header('Content-Disposition: attachment;filename="All Part Time school fees.xls"');
  $object_writer->save('php://output');		
...
exit();		
	...
	if($checkSession<2019 && $academic_session=='2017/2018'){
		 $this->load->library("excel");
  $object = new PHPExcel();
  ...
  $object->setActiveSheetIndex(0);
		...
		$page_data['payments']= $this->db->query("SELECT * FROM applicationinvoice_gen WHERE  status='Approved'
			and acadsession='$academic_session' and paymentid=5 AND (payerID like '8%' OR payerID like '9%' OR payerID like '7%') and programName  like 'ND%' ")->result_array();
		...
		$page_data['payments']= $this->db->query("SELECT * FROM applicationinvoice_gen WHERE  status='Approved'
			and acadsession='$academic_session' and paymentid=70 AND (payerID like 'P/ND/15%' OR payerID like 'P/ND/16%' OR payerID like 'P/ND/14%' OR payerID like 'P/ND/13%' ) 
			and programName  like 'ND%' ")->result_array();
		...
		$page_data['payments']= $this->db->query("SELECT * FROM applicationinvoice_gen WHERE  status='Approved'
			and acadsession='$academic_session' and paymentid=70 AND (payerID like 'P/HD/15%' OR payerID like 'P/HD/16%' OR payerID like 'P/HD/14%' OR payerID like 'P/HD/13%') 
			and programName  like 'HND%' ")->result_array();
	  ...
	  foreach($payments as $row)
  {
	  $regNo=$row['payerID'];
	  $programName=$row['programName'];
								$regNoCheck1=strtoupper(substr("$regNo",0,1));
								$regNoCheck2=strtoupper(substr("$regNo",0,3));
							
								$regNoCheck3=strtoupper(substr("$regNo",0,7));
								$programDetailsCheck=substr("$programName",0,3);
   $sn+=1;
   $object->getActiveSheet()->setCellValueByColumnAndRow(0, $excel_row, $sn);
   $object->getActiveSheet()->setCellValueByColumnAndRow(1, $excel_row, $row['payerID']);
   ...
   $object->getActiveSheet()->setCellValueByColumnAndRow(8, $excel_row, $row['programName']); 
   $object->getActiveSheet()->setCellValueByColumnAndRow(9, $excel_row, $row['dategenerated']);
     if($regNoCheck1==8 || $regNoCheck1==9 || $regNoCheck1==7){
	   $object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND I');
							...
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND I');
								...
								if($regNoCheck2=='YCT'&& $programDetailsCheck=='CP '){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'CERTIFICATE I');	
								
								}
								if($regNoCheck2=='YCT'&& $programDetailsCheck=='PGD '){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'PGD I');	
							...
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND I');	
								...
								if($regNoCheck3=='F/ND/16' || $regNoCheck3=='F/ND/13'|| $regNoCheck3=='F/ND/14' || $regNoCheck3=='F/ND/15'|| $regNoCheck3=='F/ND/12'|| $regNoCheck3=='F/ND/11'){
										$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND II');	
								...
								if($regNoCheck3=='P/ND/16'){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND II');	
									
								}
										if($regNoCheck3=='F/BS/17'){
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'BSC I');	
								
								}
								if($regNoCheck3=='F/BS/16'){
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'BSC II');	
								
								}
								if($regNoCheck3=='F/BS/15'){
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'BSC III');	
								
								}
								if($regNoCheck3=='F/BS/14'|| $regNoCheck3=='F/BS/13' || $regNoCheck3=='F/BS/12'){
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'BSC IV');	
								
								}
								if($regNoCheck3=='P/CE/17'){
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'CERTIFICATE I');	
							...
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND I');	
								...
								if($regNoCheck3=='F/HD/16' || $regNoCheck3=='F/HD/14' || $regNoCheck3=='F/HD/15'|| $regNoCheck3=='F/HD/12'|| $regNoCheck3=='F/HD/13'|| $regNoCheck3=='F/HD/11'){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND II');	
								...
								if($regNoCheck3=='P/HD/16'){
							$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND II');	
									
								}
									if($regNoCheck3=='P/HD/13' || $regNoCheck3=='P/HD/14' || $regNoCheck3=='P/HD/10' || $regNoCheck3=='P/HD/09'|| $regNoCheck3=='P/HD/15'|| $regNoCheck3=='P/HD/11' || $regNoCheck3=='P/HD/12' || $regNoCheck3=='P/HD/07'){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'HND III');	
									
								}
								if($regNoCheck3=='P/ND/13' || $regNoCheck3=='P/ND/14'|| $regNoCheck3=='P/ND/15' || $regNoCheck3=='P/ND/12' || $regNoCheck3=='P/ND/11' || $regNoCheck3=='P/ND/09' || $regNoCheck3=='P/ND/10' ){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'ND III');	
																
								}
								if($regNoCheck3=='F/PD/15' ){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'PD II');	
																
								}
								if($regNoCheck3=='F/PD/16' ){
								$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, 'PD I');	
...
FROM   eduportal_fees_payment_log where posted_citm='0'")or die( print_r( sqlsrv_errors(), true));
 while(list($id, $regno, $payment_code, $payment_session, $payment_level, $payment_amount, $payment_status, $payment_date, $payment_fee_type, $student_id, $semester)=sqlsrv_fetch_array($application_query))
						{
$adm= sqlsrv_query($conn,"SELECT  application_no, surname, firstname, middlename from eduportal_admission_list where application_no='$regno'")or die( print_r( sqlsrv_errors(), true));
...
echo '<br/>';
  ...
  // echo $item3["Subject"].' '.$item3["Grade"]."<br/>" ;
	...
	sqlsrv_query($conn,"update eduportal_fees_payment_log set posted_citm='1' where regno='$application_no'") or die( print_r( sqlsrv_errors(), true));
...
echo $exception->getMessage();
  ...
  // $this->session->userdata('admin_login');
   $this->load->view('backend/index',$page_data);
	...
	// ACCEPTANCE FEES SINGLE PAYMENT POST WEB SERVICETYPEID

// Web service api to get payment details from CITM server
   public function postpaymentsingleacceptanceFees($rrr)
   {
   	session_start();
	//include('phpseclib/Crypt/RSA.php');
...
$application_query= sqlsrv_query($conn,"SELECT  putme_id,rrr, session,payment_level,amount, status, convert(varchar, datetime, 23) 
FROM   eduportal_remita_accp_temp_data where rrr='$rrr'")or die( print_r( sqlsrv_errors(), true));
 while(list($putme_id,$rrr, $session, $payment_level, $amount, $status, $datetime)=sqlsrv_fetch_array($application_query))
						{
							
$adm= sqlsrv_query($conn,"SELECT  portal_id, name, othername from student where portal_id='$putme_id'")or die( print_r( sqlsrv_errors(), true));
