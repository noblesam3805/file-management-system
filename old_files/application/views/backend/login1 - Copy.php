			...
			<header>
				...
				<section>
					...
					<div class="headchatdiv">
						...
						<p class="headchat"><i class="icon-chat"></i> Whatsapp Chat</p>

						<p class="headchat">Call 24/7 &nbsp; +2349029776883 , Email: support@gtcocalscan.com</p>
...
<br/>
<p>Please Note: To Generate Invoice for Damage Fee, LATE Fee, Completion of School Fee etc, login and choose Other Fees.</p>
					</div>
				...
				<div class="inner">	
			        ...
			        <div class="row">
			        	<!-- <div class="col-md-6"><h4 class="stdhead"></h4></div> -->
			        	<div class="col-md-9">
			        	  <p style="font-family: OpenSans-Light;line-height: 30px; font-size: 16px;">ACCEPTANCE FEES</p></div>
						<div class="col-md-9">
<p style="font-size:16px; color:#215277;"><a target="" href="<?php echo base_url() . 'index.php?register/account_verification_acceptancefees'; ?>">Generate Acceptance Fee Payment Invoice</a></p>
</div>
<div class="col-md-9">
<p style="font-size:16px; color:#215277;"><a target="" href="<?php echo base_url() . 'index.php?register/pay_acp_fees'; ?>">Acceptance Fee Confirmation and Receipt </a></p>
</div>
					...
					<h4 class="stdhead">i: Old School Fees Payment Confirmation(Without Portal Account)</h4>

					<div class="row">
			        	<div class="col-md-3"><h4 class="stdhead">Old Students</h4></div>
			        	<div class="col-md-3"><p style="font-size:16px; color:#215277;"><a target="_top" href="<?php echo base_url() . 'index.php?payment/remitaGetReceipt'; ?>">HND/ND Morning</a> </p></div>
			        	<div class="col-md-6"><p style="font-size:16px; color:#215277;"><a target="_top" href="<?php echo base_url() . 'index.php?payment/etranzactConfirmation'; ?>">HND/ND Evening/ Weekend</a> </p></div>
			      	</div>
			      	<div class="row">
			        	<div class="col-md-3"><h4 class="stdhead">New Students</h4></div>
			        	<div class="col-md-3"><p style="font-size:16px; color:#215277;"><a target="_top" href="<?php echo base_url() . 'index.php?payment/remitaGetReceipt'; ?>">HND/ND Morning </a></p></div>
			        	<div class="col-md-6"><p style="font-size:16px; color:#215277;"><a target="_top" href="<?php echo base_url() . 'index.php?payment/etranzactConfirmation'; ?>">HND/ND Evening/ Weekend</a></p></div>
			      	</div>
