<?php session_start(); 
	...
	if($_SESSION["JAMBNO"]){
	$applicant_data= $this->db->get_where('jamb_students', array("jamb_regno" => $_SESSION["JAMBNO"]))->row();
	}
?>
<style type="text/css">
	.foreign-form{
					...
					<div class="col-md-12 no-p">
						...
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
									<input type="text" name="firstname" required class="form-control eduportal-input" placeholder="First Name"  value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->firstname;
	}?>" />
								</div>
							</div>
						</div>
					...
					<div class="col-md-12 no-p">
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
								<input type="text" name="middlename" required class="form-control eduportal-input" placeholder="Middle Name"  value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->middlename;
	}?>"/>
								</div>
							</div>
						</div>
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
								<input type="text" name="lastname" required class="form-control eduportal-input" placeholder="Last Name"  value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->lastname;
	}?>"/>
								</div>
							</div>
						</div>
					...
					<div class="col-md-12 no-p">
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								<label class="label-control" for="course name">Matric Number</label>
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
												<input type="text" name="regno" required class="form-control eduportal-input" placeholder="Matric / Jamb Number" <?php if($_SESSION["JAMBNO"]){?> value="<?php echo $_SESSION["JAMBNO"];?>" readonly="readonly"<?php }?>/>
								</div>
							</div>
						</div>
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
								<input type="text" name="phone" required class="form-control eduportal-input" placeholder="Valid Number [ Eg: 08031234567 ]" value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->phone;
	}?>"/>
								</div>
							</div>
						</div>
							...
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									...
									<select name="sex" required class="form-control eduportal-input">
										<?php if($_SESSION["JAMBNO"]){?>
                              <option value="<?php echo $applicant_data->sex;?>" selected="selected"><?php echo $applicant_data->sex;?></option>
                              <?php }?>
                                        <option value="">Select An Option</option>
					...
					<div class="col-md-12 no-p">
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
									<input type="text" name="dob" required class="form-control eduportal-input datepicker" data-start-view="2" placeholder="Date Of Birth" value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->date_of_birth;
	}?>"/>
								</div>
							</div>
						</div>
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
									<input type="text" name="address" required class="form-control eduportal-input" placeholder="Your Address" value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->address;
	}?>"/>
								</div>
							</div>
						</div>
					...
					<div class="col-md-12 no-p">
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
									<input type="text" name="pname" required class="form-control eduportal-input" placeholder="Name Of Parent / Guardian" value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->parent_name;
	}?>"/>
								</div>
							</div>
						</div>
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
									<input type="text" name="pphone" required class="form-control eduportal-input" placeholder="Phone Number Of Parent / Guardian" value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->parent_phone;
	}?>"/>
								</div>
							</div>
						</div>
					...
					<div class="col-md-12 no-p">
						<div class="col-md-12 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
									<input type="text" name="paddr" required class="form-control eduportal-input" placeholder="Address Of Parent / Guardian" value="<?php if($_SESSION["JAMBNO"]){
	echo $applicant_data->parent_address;
	}?>"/>
								</div>
							</div>
						</div>
							...
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									...
									<select name="dept" required class="form-control eduportal-input">
										<option value="">Select An Option</option>
										<?php foreach($dept as $d => $val): ?>
											<option value="<?php echo $val['deptID']; ?>"><?php echo $val['deptName']; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									...
									<select name="prog_type" required class="form-control eduportal-input">
										<option value="">Select An Option</option>
										<option value="DEGREE REGULAR">DEGREE REGULAR</option>
										<option value="DEGREE SANDWICH">DEGREE SANDWICH</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 no-p">
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									...
									<select name="prog_type" required class="form-control eduportal-input">
										<option value="">Select An Option</option>
										<option value="NCE REGULAR">NCE REGULAR</option>
							...
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									...
									<select name="clevel" required class="form-control eduportal-input">
										...
										<option value="NCE 4">NCE 4</option>
									</select>
								</div>
							</div>
						</div>
