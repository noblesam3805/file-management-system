<?php session_start(); 
	...
	$this->db->like('programme', 'morning');
	$morning = $this->db->get('fees_schedule')->result_array();
...
<div class="col-md-10 middle">
	...
	<div class="col-md-12">
		...
		<div class="col-md-8 middle" style="margin-top:10px;">
			...
			<?php echo form_open('payment/remita_pay', array('class' => 'form-groups-bordered validate','target'=>'_top')); ?>
