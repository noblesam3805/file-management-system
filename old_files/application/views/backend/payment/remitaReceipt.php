...
<?php
    ...
    if (isset($_REQUEST['size']))
		...
		$link = "http://www.fpno.edu.ng/nekede/index.php?fee/qr_check/" . $_SESSION['putmeID'] . '/' . $_SESSION['rrr'];
    ...
    if(substr($_SESSION['portalID'], 0, 4) == 'PHND'){
		...
		$student = $this->db->get_where('fpnoedup_portalfp_portal.prehnd_students', array("putme_id" => $_SESSION['portalID']))->row();
	...
	$payDetails2 = $this->db->get_where('eduportal_remita_temp_data', array("rrr" => $_SESSION['rrr']))->row();
							...
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><p><?php echo 'N'.number_format( (float) $payDetails->amount, 2, '.', ','); ?></p></td>
