<?php session_start(); 
	...
	$morning = $this->db->query("SELECT DISTINCT (programme)FROM  `fees_schedule` WHERE programme LIKE  '%morning%'")->result_array();
	...
	<div class="col-md-12 no-p">
		<div class="step-bar">
			...
			<div class="page-title">
				<p><?=$page_title?> : Student's admitted before the 2015/2016 academic session</p>
			</div>
		</div>
	</div>
	<div class="col-md-12">
		...
		<div class="col-md-8 middle" style="margin-top:10px;">
			...
			<?php echo form_open('payment/res_old_student', array('class' => 'form-groups-bordered validate','target'=>'_top')); ?>
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="form-group eduportal-form-group p20">
								<label class="label-control" for="course name">Reg Number/Application No</label>
								<div class="input-group input-group-lg eduportal-input-group">
							...
							<div class="form-group eduportal-form-group p20">
								...
								<div class="input-group input-group-lg eduportal-input-group">
									...
									<select name="prog" required class="form-control eduportal-input">
										<option value="">Select An Option</option>
										<?php
											foreach($morning as $prog => $val): ?>
												<option value="<?php echo $val['programme']; ?>"><?php echo $val['programme']; ?></option>
											<?php endforeach;
										?>
									</select>
								</div>
					...
					<div class="col-md-12">
						<div class="form-group eduportal-form-group p20" style="text-align:center;">
							<label>&nbsp;</label>
							<button type="submit" name="" style="width:200px;padding:10px; 35px" class="btn btn-info"><i class="glyphicon glyphicon-floppy-saved"></i> &nbsp;Submit</button>
						</div>
					</div>
					<?php echo form_close(); ?>
				</div>
