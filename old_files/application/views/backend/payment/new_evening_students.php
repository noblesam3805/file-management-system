					...
					<div class="col-md-12" id="">
						<div class="widget stacked">
							<div class="widget-content" style="padding:10px 20px;">
								...
								<?php echo form_open('payment/new_pay_fees/start', array('class' => 'form-groups-bordered validate','target'=>'_top')); ?>
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group text-center">
										<button type="submit" name="" style="width:200px;padding:10px; 35px" class="btn btn-success">Continue</button>
									</div>
								</div>
								<?php echo form_close(); ?>
							</div>
