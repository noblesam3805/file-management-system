<?php
	...
	$payDetails2 = $this->db->get_where('invoice_gen', array("rrr" => $_SESSION['payeeID']))->row();
	
	$feeType = $this->db->get_where('eduportal_fees_payment_log', array("payment_code" => $_SESSION['payeeID']))->row();
		...
		<div class="widget stacked">
			...
			<div class="widget-content" style="padding:10px 20px;">
				...
				<div class="col-md-12 receipt-head">
					...
					<p><?php echo ucwords(strtolower($payDetails2->fee_description));?> Payment Receipt</p>
...
Passport
					...
					<div class="col-md-12 no-p">
						...
						<div class="col-md-12 print-table">
						  <table class="table table-bordered table-striped table-hover">
						    <tbody>
						      <tr>
						        ...
						        <td><p>N<?php echo number_format($payDetails2->amount,2); ?></p></td>
					          </tr>
						     	 <tr>
						      ...
						      <tr>
						        <td><p>Session</p></td>
						        <td><p><?php echo $payDetails2->session_id; ?></p></td>
					          </tr>
						  ...
						  if($feeType->payment_fee_type == 4){?>
                          <p><img src="images/microsoft.jpg" />&nbsp;</p>
                          <?php
						  }
						  ?>
						</div>
