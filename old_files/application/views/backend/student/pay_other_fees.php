	...
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs bordered">
          	...
          	<!--li>
            	...
            	<?php echo get_phrase('Other_Fees_payment_form');?>
             	</a>
            </li-->
            <li class="active">
		        <a href="#pid" data-toggle="tab"><i class="entypo-credit-card"></i>
	            <?php echo 'Other Fees Confirmation Form';?>
                </a>
            </li>
            
            		<li>
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
					<?php echo get_phrase('Other_Fees_Payment_History');?>
                </a>
            </li>
	...
	<div class="widget stacked widget-table">
                ...
                <div class="tab-pane box active" id="pid" style="padding: 5px">
					...
					<div class="box-content">
						...
						<?php  echo form_open('student/processOtherFeePayment', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));  ?> <input type="hidden" name="portalID" value="<?php echo $my_data->portal_id;?>" />
            	...
            	<div class="form-group">
				<label class="col-sm-3 control-label" for="course name">RRR</label>
				<div class="col-sm-5">
