...
<div class="row">
	<div class="col-md-12">
		<?php if($stu_prog==4){ echo form_open('student/processRemitaAcceptanceInvoice', array('class' => 'form-groups-bordered validate','target'=>'_top')); }else {echo form_open('student/processRemitaAcceptanceInvoice', array('class' => 'form-groups-bordered validate','target'=>'_top'));} ?>
