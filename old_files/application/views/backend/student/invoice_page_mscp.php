		...
		<div class="widget stacked">
			...
			<div class="widget-content" style="padding:10px 20px;">
				...
				<div class="col-md-12 receipt-head">
					...
					<p> Microsoft Collaboration Platform Fee Invoice</p>
...
<form action="http://portal.fpno.edu.ng/nekede/apis/payremitaonline.php" name="SubmitRemitaForm1" id="SubmitRemitaForm1" method="POST"> 
                  
                  <input name="rrr" value="<?php echo $applicationinvoice->rrr;?>" type="hidden"> 
                  <input name="responseurl" value="<?php echo "http://portal.fpno.edu.ng/nekede/apis/payonlineresponse.php";?>" type="hidden"> 
