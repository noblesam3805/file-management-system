<?php session_start();
 $receipts=  $this->db->query("select* from eduportal_fees_payment_log where student_id='".$this->session->userdata('student_id')."' and payment_fee_type='4'");
	...
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs bordered">
          	...
          	<!--li>
            	...
            	<?php echo get_phrase('Microsoft_Collaboration_Fee_payment_form');?>
             	</a>
            </li-->
            <li class="active">
		        <a href="#pid" data-toggle="tab"><i class="entypo-credit-card"></i>
	            <?php echo 'MSCP Fee Confirmation Form';?>
                </a>
            </li>
            
            		<li>
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
					<?php echo get_phrase('MSCP_Fee_Payment_History');?>
                </a>
            </li>
	...
	<div class="widget stacked widget-table">
                ...
                <div class="tab-pane box active" id="pid" style="padding: 5px">
					...
					<div class="box-content">
						...
						<?php  echo form_open('student/processMSCPPayment', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));  ?> <input type="hidden" name="portalID" value="<?php echo $my_data->portal_id;?>" />
            	...
            	<div class="form-group">
				<label class="col-sm-3 control-label" for="course name">Confirmation Code</label>
				<div class="col-sm-5">
			 ...
			 <div class="form-group ">
				<label class="col-sm-3 control-label" for="course name">Payment Platform</label>
				<div class="col-sm-5">
					...
					<select name="pmode" required class="form-control eduportal-input">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo get_phrase('Confirm MSCP Fee Payment');?></button>
                            </div>
                        </div>
