...
alert("Please Kindly Update your profile with your school Matriculation no before Registering your semester course. Note that your Course Registration will not be approved if you have not updated your profile with your Matric No! Also Remember, no school Fee Payment, No Course Registration. THANK YOU !!!");
</script>
<?php 
session_start();
...
<div class="row">
	...
	<div class="col-md-12">
    	...
    	<!--CONTROL TABS END--><form id="imageform" name="imageform" method="post"  action='index.php?student/process_reprint_course_regslip' >
		<div class="widget stacked widget-table">
			...
			<h3>Reprint Semster Courses ! </h3> <span style="color:#FF0000; font-size:18px"></span>
			<hr />
