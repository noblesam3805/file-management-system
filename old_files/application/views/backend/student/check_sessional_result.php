...
<div class="row">
	...
	<div class="col-md-12">
    	...
    	<!--CONTROL TABS END--><form id="imageform" name="imageform" method="post"  action='index.php?student/process_check_sessional_result' >
		<div class="widget stacked widget-table">
			...
			<h3>Check Semester/Sessional Results ! </h3> <span style="color:#FF0000; font-size:18px"></span>
			<hr />
