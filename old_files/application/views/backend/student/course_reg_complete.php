...
$courses_registereddetails2=$courses_registered2->row();
    ...
    if (isset($_REQUEST['size']))
		...
		$link = "http://45.34.15.68/portal/index.php?student/qrCheck/".$student_id."/".$this->session->userdata('semester_id')."/".$this->session->userdata('sess')."/".$this->session->userdata('level_id');
...
<div class="print_page">
			...
			<img src="images/neklogo.png" />
						  ...
						  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" class="formtxt">
						    ...
						    <tr>
						      ...
						      <td width="23%" rowspan="12" valign="top"><img src="<?php 
									...
									echo $photo; ?>" width="120px" height="120px" /><img src="<?php echo $filename;?>" width="120px" height="120px" /></td>
					        </tr>
						    <tr>
				...
				foreach($courses_registered->result() as $row)
			  {
				 $course_assigned_id= $row->course_assign_to_dept_id;
				  $query4 =sqlsrv_query($conn,"select* from course_assigned_to_department where id='$course_assigned_id'") or die("Error1:".sqlsrv_errors());
                ...
                <tbody>
                  ...
                  <tr  style="border-bottom:1px solid #000;">
                    <td><?php echo $id2;?></td>
                    <td> <?php $q4=sqlsrv_query($conn,"select *  from eduportal_courses where course_id='$courseid2'")or die("Error1:".sqlsrv_errors());
		  
		  while(list($courseid1,$coursecode1,$course_title1)=sqlsrv_fetch_array($q4))
		  {echo  $coursecode1;}?>&nbsp;</td>
                    <td><div align="left"><span class="style5"><?php $q2=sqlsrv_query($conn,"select *  from eduportal_courses where course_id='$courseid2'")or die("Error1:".sqlsrv_errors());while(list($courseid2,$coursecode2,$course_title2)=sqlsrv_fetch_array($q2))
 ...
 where course_type_id='$course_type_id2'")or die("Error1:".sqlsrv_errors());while(list($course_type_id2,$course_type_name2)=sqlsrv_fetch_array($q3))
		  {echo  $course_type_name2;}?>
				...
				$tcu= $tcu +$course_unit2;
				  ...
				  ?>
						          ...
						          <p>First Semester Total Credit Units: <?php echo  $tcu;?> </p>
		  ...
		  {echo  $coursecode1;}?>
						                ...
						                <td><div align="left"><span class="style5">
						                  <?php $q2=sqlsrv_query($conn,"select *  from eduportal_courses where course_id='$courseid2'")or die("Error1:".sqlsrv_errors());while(list($courseid2,$coursecode2,$course_title2)=sqlsrv_fetch_array($q2))
		  {echo  $course_title2;}?>
						                  </span></div></td>
						                <td><div align="center"><?php echo $course_unit2;?></div></td>
						                <td><div align="left">
		  ...
		  {echo  $course_type_name2;}?>
				...
				$tcu2= $tcu2 +$course_unit2;
				  ...
				  ?>
						    ...
						    <tr class="border">
						      <th class="style27" scope="row" align="left">Signature of Class Adviser .............................................</th>
						    ...
						    <tr class="border">
						      <th width="46%" class="style27" scope="row" align="left">Signature of Faculty Dean   ..............................................</th>
						      <td width="54%">&nbsp;</td>
					        </tr>
                                <tr class="border">
						      <th class="style27" scope="row" align="left">&nbsp;</th>
						    ...
						    <tr>
						      <th height="2" colspan="2" class="sectionText" scope="row"></th>
					        </tr>
					      </table>
					  </div>
					</div>
					<div class="col-md-12 no-p">
					  <div class="col-md-12 print-table"></div>
					</div>
					<div class="col-md-12 no-p">
						<table class="table">
							<tbody>
