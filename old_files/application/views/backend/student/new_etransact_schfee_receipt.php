...
redirect(base_url() . 'index.php?student/remita_acp_receipt');
	...
	$payDetails = $this->db->get_where('eduportal_fees_payment_log', array("confirm_code" => $_SESSION['payeeID']))->row();
							...
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><p><?php echo $payDetails->regno; ?></p></td>
									...
									<tr>
										...
										<td><p><?php echo $payDetails->payment_code; ?></p></td>
							...
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><p><?php echo $payDetails->payment_amount; ?></p></td>
						      ...
						      <tr>
						        <td><p>Session</p></td>
						        <td><p><?php echo $payDetails->payment_session; ?></p></td>
					          </tr>
									...
									<tr>
										...
										<td><p><?php echo $payDetails->payment_date; ?></p></td>
