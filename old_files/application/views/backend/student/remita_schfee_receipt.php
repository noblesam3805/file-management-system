		...
		<div class="widget stacked">
			...
			<div class="widget-content" style="padding:10px 20px;">
				...
				<div class="col-md-12 receipt-head">
					...
					<p><?php if($payDetails3->payment_fee_type==1){echo "Acceptance Fee";} else {echo $payDetails2->fee_description;} ?> Payment Receipt</p>
						  ...
						  <table class="table table-bordered table-striped table-hover">
						    <tbody>
						      <tr>
						        ...
						        <td><p>N<?php echo number_format($payDetails3->payment_amount); ?></p></td>
					          </tr>
						     	 <tr>
						        <td><p>Purpose Of Payment</p></td>
						        <td><p><?php if($payDetails3->payment_fee_type==1){echo "Acceptance Fee ";} else {echo $payDetails2->fee_description;} ?></p></td>
					          </tr>
						      <tr>
						        <td><p>Level</p></td>
