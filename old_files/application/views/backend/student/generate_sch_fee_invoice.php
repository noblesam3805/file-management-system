...
<div class="row">
	<div class="col-md-12">
		<?php if($stu_prog==1 || $stu_prog==4){ echo form_open('student/processRemitaSchoolFeeInvoice', array('class' => 'form-groups-bordered validate','target'=>'_top')); }else {echo form_open('student/processEtransactSchoolFeeInvoice', array('class' => 'form-groups-bordered validate','target'=>'_top'));} ?>
		<div class="col-md-6 no-p">
            ...
            <input type="hidden" name="prog" value="<?php echo $programme->student_type_name;?>" />
              <input type="hidden" name="programme_type_id" value="<?php if($stu_prog==4){echo '7';} if($stu_prog==5){echo '8';} if($stu_prog==6){echo '9';}  if($stu_prog==1){echo '10';}  if($stu_prog==2){echo '11';} if($stu_prog==3){echo '12';}?>" />
