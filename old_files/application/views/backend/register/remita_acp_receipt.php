<?php
    ...
    if (isset($_REQUEST['size']))
		...
		$link = "http://erp.yabatech.edu.ng/portal/index.php?payment/qr_check/". $_SESSION['payeeID'];



        $filename = 'temp/putme'.md5($link.'|'.$errorCorrectionLevel.'|'.$matrixPointSize).'.jpg';
	...
	$student = $this->db->get_where('student', array("student_id" => $this->session->userdata('newstudent_id')))->row();
	...
	$payDetails2 = $this->db->get_where('eduportal_remita_accp_temp_data', array("rrr" => $_SESSION['payeeID'],"status"=>"Approved"))->row();
					...
					<div class="col-md-12 no-p">
							...
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><p><?php
										if($payDetails3->payment_code==''){
										 echo  $payDetails2->rrr;	
										}else{
										echo $payDetails3->payment_code;
										}
										?></p></td>
						...
						<div class="col-md-2 no-p">
							...
							<div class="col-md-12 no-p receipt-image-div">
								...
								<img src="http://erp.yabatech.edu.ng/application/files/<?php 

include('application/config/kee2.php');
$result =sqlsrv_query($conn,"SELECT passport_url  FROM      hnd_applicants_form  where application_no='$student->portal_id'") or die(0);
while($row= sqlsrv_fetch_array($result))
{
							echo	 $row["passport_url"]; 
							...
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><p><?php 
										if($payDetails3->payment_amount==''){
											echo $payDetails2->amount;
										}else{
										echo $payDetails3->payment_amount; 
										}
										?></p></td>
									...
									<tr>
										...
										<td><p><?php 
										if($payDetails3->payment_session==''){
											echo $payDetails2->session;
										}else{
										echo $payDetails3->payment_session; 
										}
										?></p></td>
									...
									<tr>
										...
										<td><p><?php
										if($payDetails3->payment_date==''){
											echo $payDetails2->datetime;
										}else{
										echo $payDetails3->payment_date; 
										}
										?></p></td>
