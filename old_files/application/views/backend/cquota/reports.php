...
//if($_SESSION['cafeUserCat']==1){
	$users = $this->db->where("qid",$_SESSION['cafeUserQid'])
	->get("quota_users");	
/*}
else{
	...
	<div class="col-md-12">
                        ...
                        <tr>
					      ...
					      <td valign="top"><table width="100%" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC" rules="all">
					        <tr>
					          ...
					          <td width="23%" valign="top"><h4><strong><?php if($report){?>No Remitted<?php }?></strong></h4></td>
					          <td width="19%" valign="top"><h4><strong><?php if($report){?>Pending<?php }?></strong></h4></td>
				            </tr>
                            <?php
							$sn2 = 0 ;
		...
		->get("quota_users_actv");
					        ...
					        <tr>
					          ...
					          <td valign="top"><?php if($report){ echo number_format($remit);}?></td>
					          <td valign="top"><?php if($report){ echo number_format($jobs - $remit);}?></td>
				            </tr>
                            <?php
					        ...
					        <tr>
					          ...
					          <td valign="top"><h4><?php if($report){ echo number_format($totalRemit);}?></h4></td>
					          <td valign="top"><h4><?php if($report){ echo number_format($totalJobs - $totalRemit);}?></h4></td>
				            </tr>
				          </table></td>
				        </tr>
						...
						?><tr>
                          ...
                          <td valign="top"><table width="100%" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC" rules="all">
                            ...
                            <tr>
                              ...
                              <td width="23%" valign="top"><h3><?php  if($report){echo number_format($tRemitted); }?></h3></td>
                              <td width="19%" valign="top"><h3><?php  if($report){ echo number_format($tJobs - $tRemitted);}?></h3></td>
                            </tr>
                          </table></td>
                        </tr>
                        <?php
