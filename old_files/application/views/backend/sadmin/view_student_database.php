                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <?php
$faculty = $this->db->query("SELECT * FROM schools WHERE id=".$row['school']."")->row()->schoolname;
							echo $faculty;?></td>
                            <td><?php 
							...
							?></td>
                            <td><?php 
							$stype = $this->db->query("SELECT * FROM programme_type WHERE programme_type_id='".$row['prog_type']."'")->row()->programme_type_name;
							echo $stype;?></td>
