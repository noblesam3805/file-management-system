				  ...
				  <div class="col-md-12 no-p">
					...
					<div class="col-md-12 no-p">
						...
						<div class="col-md-12 print-table">
						  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" style="height:700px;">
						    <tr>
						      <th height="43" colspan="2" class="sectionText" scope="row" valign="top"> <div id="sales2">
						      <p><br /><b><?php echo $session;?>&nbsp;SESSIONAL EXAMINATION RESULT</b></p>
						      <table width="80%"  class=""    >
						          <thead>
						            <tr bgcolor="#ffffff"></tr>
						            <tr bgcolor="#ffffff">
						              <th width="39"><div align="left" class="style6"><span class="style4">DEPT.</span></div></th>
						              <th width="100"><div align="left" class="style6"><span class="style4">COURSE NO</span></div></th>
						              <th width="257"><div align="left" class="style6">COURSE TITLE</div></th>
                                       <th width="70"><div align="left" class="style6">CREDIT UNIT</div></th>
						           
						              
						              <th width="70"><div align="center" class="style6">LETER GRADE</div></th>
                                          <th width="70"><div align="center" class="style6">GRADE POINTS</div></th>
					                </tr>
				                </thead>
				  ...
				  $ct = $row->course_type;
						?>
						            <tr  style="border-bottom:1px solid #000;">
						              ...
						              <td>
						               <?php echo strtoupper($row->course_code);?> &nbsp;</td>
						              <td><div align="left"><span class="style5">
						              
					                  </span><?php echo strtoupper($row->course_title);?></div></td>
                                        <td><div align="center"><span class="style5">
						              <?php echo strtoupper($row->course_unit);?>
					                  </span></div></td>
						    ...
						    <?php $gp =  number_format(getGP(number_format($row->totalscore),$row->course_unit),2);
					 echo $gp;
					 ?> 
						                </div></td>
					                </tr>
