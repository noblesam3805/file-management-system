...
{
var check = confirm("Do you want to delete this staff record?");
if(check==true)
{
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <?php
$faculty = $this->db->query("SELECT * FROM schools_staff WHERE id=".$row['school_id']."")->row()->schoolname;
							echo $faculty;?></td>
                            <td><?php 
							$dept = $this->db->query("SELECT * FROM department_staff WHERE deptID=".$row['dept_id']."")->row()->deptName;
							echo $dept;?></td>
							   
							<td><a href="#index.php?sadmin/editadmislist/<?php echo $row['id'];?>" class="btn btn-danger btn-sm " >
                       Edit
                     </a>| <a href="index.php?sadmin/delete_stafflist/<?php echo $row['id'];?>" class="btn btn-success btn-sm "  onclick="checkdel()">
                        Delete  </a></td>
                            <?php $i++;?>
