...
<tr>
  ...
  <?php foreach($payments->result() as $row2)
	...
	{
		$rrr= $row2->rrr;
		$q= mysql_query("select channel,trans_date,rrr from eduportal_remita_payment where rrr = '$rrr'") or die(mysql_error());
		while(list($channel,$trans_date,$rrr)=mysql_fetch_array($q))
		{
  ...
  <tr>
	...
	$sn++;	}  
		  ...
		  <tr>
    <td width="25" colspan="8">TOTAL AMOUNT: <?php echo number_format($total);?></td>
