            ...
            <!-- button starts -->
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right dropdown-menu-right" role="menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php?admin/etranzact/">
                                <i class="entypo-credit-card"></i>
                                    <?php echo get_phrase('All_banks');?>
                                </a>
                                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php?admin/etranzact/Zenith">
                                <i class="entypo-credit-card"></i>
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php?admin/etranzact/First">
                                <i class="entypo-credit-card"></i>
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php?admin/etranzact/FCMB">
                                <i class="entypo-credit-card"></i>
                                    <?php echo get_phrase('FCMB');?>
                                </a>
                                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php?admin/etranzact/Alvana">
                                <i class="entypo-credit-card"></i>
	   ...
	   <div class="widget-content">
		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><!--a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/etranzact/delete/<?php echo $row['confirm_code'];?>')">
                                <button type="submit" class="btn btn-danger xs-3"><i class="entypo-credit"></i>X</button>
                            </a-->
                            </td>
                            <?php $i++;?>
                        </tr>
                ...
                ?>
                <div class="col-md-12"><b><p>The total number of unmatched payments from etranzact: <?php echo $total; ?></p></b></div>
			</div>
