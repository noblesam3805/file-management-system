...
<div class="row">
	...
	<div class="col-md-12">
    	...
    	<!--CONTROL TABS END--><form id="imageform" name="imageform" method="post"  action='index.php?sadmin/ajax_submit_coursereg' >
		<div class="widget stacked widget-table">
			...
			<div style="margin-left:30px">
			  ...
			  <p> <div style="width:100%; height:100%" align="center">
                    <p align="left">
                      Matric No: <?php echo $stuReg->reg_no;?>
                    
                  </p>
                    <p align="left">
                      Student Name: <?php echo $stuReg->name.' '.$stuReg->othername;?>
				  ...
				  <p align="left">Programme: <?php  echo $student_type_name;?>
                      ...
                      <?php 
					   ...
					   $this->session->set_userdata(array('levelname'=>$levelname)); 
					  ?></p>
              ...
              <p align="left"><h3>Courses Available for this semester !</h3>  </p>
 ...
 where course_type_id='$course_type_id2'")or die (mysql_error());while(list($course_type_id2,$course_type_name2)=mysql_fetch_array($q3))
		  {echo  $course_type_name2;}?>
                    ...
                    <td align="center"><?php if($row->approved){?> <?php echo "Approved"; } else {?><a href="index.php?sadmin/drop_registered_course/<?php echo $row->course_registered_id;?>"><img src="images/error.PNG" alt="" title="Drop Course" /></a><?php }?></td>
                  </tr>
                </tbody>
                <?php 
				  $id2 = $id2 +1;
				  ...
				  {
					  ?>
               <a href="index.php?sadmin/course_reg_complete/<?php echo $student_id;?>"> <h4><strong><b>Click Here to Print  Course Reg Slip </b></strong></h4></a><br /><?php
				  }
...
<input type="hidden" name="level_of_study" value="<?php echo $levelname;?>"/>
				  ...
				  $this->session->set_userdata(array('sess'=>$session_id));
						...
						$this->session->set_userdata(array('stud_id'=>$student_id));
