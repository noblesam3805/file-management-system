        ...
        <div class="tab-content">
			...
			?>
                        <tr>
                            ...
                            <td> 
                       <a href="#" class="btn btn-success btn-sm " onclick="window.open('http://45.34.15.68/application/admissions/qr_check2/<?php echo $row["pin"];?>','MsgWindow', 'width=900,height=600')"> View Full Details</a>   </td>
							<td>
