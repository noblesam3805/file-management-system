		...
		<ul class="nav nav-tabs bordered">
			...
			<li  class="active">
            	...
            	<a href="#manage" data-toggle="tab"><i class="entypo-menu"></i>
					...
					<?php echo "Manage Staff ID Card Record";?>
		...
		<div class="widget stacked widget-table">
			...
			<div style="margin-left:30px">
			  ...
			  <p><div style="width:100%; height:100%" align="center">
                  <form id="imageform2" name="imageform2"  method="post" enctype="multipart/form-data" action='index.php?sadmin/view_staff_data_idcard_database' onsubmit="" >
...
<?php 
	...
	?>
                      ...
                      <p align="left">
                        <input type="submit" name="view" id="view" value="View Staff ID Records" class="btn btn-primary">
                      </p>
                  </form>
