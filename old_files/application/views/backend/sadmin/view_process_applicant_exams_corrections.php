            ...
            <div class="tab-pane box active" id="list">
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <?php $j=1;?>
                        <?php 
						$details =sqlsrv_query($conn,"SELECT * FROM View_Applicant_Data where dept_id='$dept' and  (has_cbt_sit = '1') AND (total_score IS NOT NULL) and cbt_score>11 order by total_score DESC")or die ( print_r( sqlsrv_errors(), true));;
					...
					$application_query= sqlsrv_query($conn,"SELECT top(1) application_no from issue_grading WHERE application_no='$application_no'")or die( print_r( sqlsrv_errors(), true));
						while(list($apno)=sqlsrv_fetch_array($application_query))
						{
