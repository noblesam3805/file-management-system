		...
		<div class="widget stacked widget-table">
			...
			<div style="margin-left:30px">
			  ...
			  <p><div style="width:100%; height:100%" align="center">
                  <form id="imageform2" name="imageform2"  method="post" enctype="multipart/form-data" action='index.php?sadmin/ajax_upload_students_list' onsubmit="" >
                      <p align="left">
                      Student Type
...
<?php 
    ...
    <p align="left">
                      Current Year or Level
                       <span id="">
       <select  name="year" id="year" ><option value="" selected="selected" onChange="">- Select Level -</option>
  ...
  <option value="3">YEAR III</option>
   ...
   <option value="5">YEAR V</option>
    <option value="6">YEAR VI</option>
					   ...
					   <p>
                        <input type="file" id="photoimgst" name="photoimgst" style="width: 228px" class="form-control eduportal-input required" />
                      </p>
                      
                      <p align="left">
                        <input type="submit" name="view" id="view" value="View Students Record" class="btn btn-primary" onclick="viewstudentlist(); return false;" >
                      </p>
                  </form>
