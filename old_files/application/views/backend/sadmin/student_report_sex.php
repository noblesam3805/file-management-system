            ...
            <!-- button starts -->
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-danger btn-sm dropdown-toggle" data-toggle="dropdown">
                        Select Sex <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu dropdown-default pull-right dropdown-menu-right" role="menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php?sadmin/student_report_sex/">
                                <i class="entypo-credit-card"></i>
                                    <?php echo get_phrase('All_Sex');?>
                                </a>
                                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php?sadmin/student_report_sex/Male">
                                <i class="entypo-credit-card"></i>
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php?sadmin/student_report_sex/Female">
                                <i class="entypo-credit-card"></i>
