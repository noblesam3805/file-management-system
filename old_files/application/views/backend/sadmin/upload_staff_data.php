<?php $school = $this->db->query("select *  from schools_staff order by schoolname");
		...
		<ul class="nav nav-tabs bordered">
			...
			<li  class="active">
            	...
            	<a href="#manage" data-toggle="tab"><i class="entypo-menu"></i>
					...
					<?php echo "Manage Students Record";?>
		...
		<div class="widget stacked widget-table">
			...
			<div style="margin-left:30px">
			  ...
			  <p><div style="width:100%; height:100%" align="center">
                  <form id="imageform2" name="imageform2"  method="post" enctype="multipart/form-data" action='index.php?sadmin/ajax_upload_staff_list' onsubmit="" >
                     
                      
                          <p align="left">
                      Unit
                       <select  name="school" id="staff_school" class="form-select required" ><option value="" selected="selected" >- Select -</option>
...
<?php 
	...
	?>
                      ...
                      Department
                     <span id="">
                      <select  name="depts" id="staff_dept" class="form-select required"><option value="" selected="selected" onChange="">- Select -</option>
					   ...
					   <p>
                        <input type="file" id="photoimgstaff" name="photoimgstaff" style="width: 228px" class="form-control eduportal-input required" />
                      </p>
                      
                      <p align="left">
                        <input type="submit" name="view" id="view" value="View Students Record" class="btn btn-primary" onclick="viewstafflist(); return false;" >
                      </p>
                  </form>
