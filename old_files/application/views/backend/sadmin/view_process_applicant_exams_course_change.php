        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <?php $j=1;?>
                        <?php 
						$details =sqlsrv_query($conn,"SELECT * FROM View_Applicant_Data where dept_id='$dept' and  (has_cbt_sit = '1') AND (total_score IS NOT NULL) and cbt_score>=10 order by total_score DESC")or die ( print_r( sqlsrv_errors(), true));;
						...
						$application_query= sqlsrv_query($conn,"SELECT top(1)  application_no,firstname,middlename,surname, email,mobile_no FROM applicationinvoice_gen WHERE application_no='$application_no' and application_type_id='12' and application_invoice_id>'80466'")or die( print_r( sqlsrv_errors(), true));
			...
			?>
					...
					?>    		</td>
							...
							<td>   <?php echo number_format($ssce_results_score+$ns,2);?>    		</td>
