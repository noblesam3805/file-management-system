...
<div class="row">
	...
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs bordered">
			...
			<li  class="active">
            	...
            	<a href="#manage" data-toggle="tab"><i class="entypo-menu"></i>
					...
					<?php echo "Backend Course Registration";?>
    	...
    	<!--CONTROL TABS END--><form id="imageform" name="imageform" method="post"  action='index.php?sadmin/ajax_view_student_coursereg_backend' >
