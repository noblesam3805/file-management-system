                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td><?php 
							...
							echo $stype;?></td>
							<td>
						<?php 	echo $row["facility"];	?>: <br/><strong>X-Ray No : </strong>
							</td>
							<td>
							<?php if($row["matric_no_issued"]==1){
							...
							{
								?>
							<a href="index.php?sadmin/generate_matric_no/<?php echo $adm->id ;?>" onclick="return confirm('Generate matriculation no for this student?');" class="btn btn-success btn-sm " >
                      Generate Matric No
							</a><?php }?></td>
                            <?php $i++;
