                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php?sadmin/payment_by_nce/">
                                <i class="entypo-credit-card"></i>
                                    <?php echo get_phrase('All_NCE_Students');?>
                                </a>
                                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php?sadmin/payment_by_nce/regular">
                                <i class="entypo-credit-card"></i>
                                    <?php echo get_phrase('NCE_Regular');?>
                                </a>
                                        </li>

                        <!-- STUDENT EDITING LINK -->
                        <li>
                            <a href="<?php echo base_url();?>index.php?sadmin/payment_by_nce/sandwich">
                                <i class="entypo-credit-card"></i>
                                    <?php echo get_phrase('NCE_Sandwich');?>
                                </a>
                                        </li>
                        <!--li class="divider"></li-->
		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
					<?php echo get_phrase('_NCE_Student_payment_list');?>
                    	</a></li>
            <!--li >
