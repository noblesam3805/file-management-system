<div class="row">
	...
	<form action="index.php?sadmin/process_view_applicant_results_by_dept_changecourse" name="SubmitRemitaForm" class="form-groups-bordered validate" method="POST">
