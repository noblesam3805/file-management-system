...
<?php
$applicant = $this->db->query("select *  from applicants_form where program_code='$progid' limit 1");
{
?>
...
$applicants = $this->db->query("select *  from applicants_form where program_code='$progid'");
	$sn=1;
