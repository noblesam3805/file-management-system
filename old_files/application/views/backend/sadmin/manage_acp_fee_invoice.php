...
function get_name($data)
	
	{
		...
		$q= sqlsrv_query($conn,"select name, othername from student where portal_id='$data'");
		while(list($name,$othername)=sqlsrv_fetch_array($q))
		{
		echo $name.' '.$othername;
		}
...
if(check==true)
{
	window.location ="index.php?sadmin/delete_acp_fee_invoice/" + str;
}
else
{
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							echo $row['putme_id'];
							?></td>
                            <td><?php //echo get_name($row['putme_id']);?></td>
							...
							<a href="#" class="btn btn-success btn-sm "  onclick="checkdel(<?php echo $row['rrrid'];?>);">
							Delete  </a><?php }?></td>
                            <?php $i++;?>
