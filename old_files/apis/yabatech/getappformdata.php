...
if(parse_url($_SERVER['HTTP_REFERER'], PHP_URL_HOST) =="portal.yabatech.edu.ng" || parse_url($_SERVER['HTTP_REFERER'], PHP_URL_HOST) =="45.34.15.68" )
{
if($paymentID==21)
{
...
$payerphone,$orderid,$paymentid,$amt,$acadsession,$paymentdescription,$paymentName,$rem,$dategenerated)=sqlsrv_fetch_array($query2))
						{
?>
<form action="choosemethod_two.php" name="SubmitRemitaForm1" id="SubmitRemitaForm1" method="POST"> 
...
sqlsrv_close($conn);
?>
<form action="choosemethod_two.php" name="SubmitRemitaForm" id="SubmitRemitaForm" method="POST"> 
...
{
?>
      <form action="chooseTransciptDestination.php" name="SubmitRemitaForm11" id="SubmitRemitaForm11" method="POST"> 
