...

  {
...

	{
...

		{
            ...
            $this->confirm =  $output['PAYMENT_CODE'];
            $this->trans_amount = $output['TRANS_AMOUNT'];
            $this->descr = $output['TRANS_DESCR'];

             if($this->customer_id == '' || $this->confirm == '' || $this->confirm == '0' || $this->trans_amount == ''){
