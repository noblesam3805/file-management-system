...
$erp_documents=$this->db->query("select* from erp_documents")->result_array();
?>
...
<div class="row">
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <?php foreach($erp_documents as $row){
							...
							//$minuted=	$this->db->get_where('erp_documents_minutes',array('minuted_by'=>$sid))->row();
						    $minuted_to= $this->db->get_where('erp_documents_minutes',array('minuted_to'=>$sid))->row()->minuted_to;
							$minuted_by= $this->db->get_where('erp_documents_minutes',array('minuted_by'=>$sid))->row()->minuted_by;
							
							if($row['addressed_to_id'] == $sid || $row['waiting_approval_by'] == $sid || $row['is_achieved'] == $sid || $sid == $minuted_to  || $sid == $minuted_by){
    ...
    <?php if($row['waiting_approval_by']==$sid)
	{
		?>
	...
	<?php }?>	 <a href="index.php?sadmin/filedms/sharefile/<?php echo $row['id'];?>" class="btn btn-primary btn-sm " style="margin-left: 7px"> Share File </a>			<?php $i++;?>
