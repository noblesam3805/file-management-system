...
<form method="post" action="index.php?sadmin/lga_report">


    <div class="form-group col-md-6">
                <label for="field-ta" class=" control-label">Select LGA</label>
                <div class="">
                              <select class="form-control" required name="lga_id">
                              <option value="">Select LGA </option>                                   
                              <?php foreach($lgas as $dept=>$val){ ?>                                 
...
<table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                    <?php $i=1; ?>
                        <?php foreach ($q_r_b_lga as $rep=>$val): ?>
