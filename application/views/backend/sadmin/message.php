...
<div class="mail-env">
    ...
    <div class="mail-sidebar" style="min-height: 800px;">
        ...
        <div class="mail-sidebar-row hidden-xs">
            <a href="<?php echo base_url(); ?>index.php?sadmin/message/message_new" class="btn btn-success btn-icon btn-block">
        ...
        <ul class="mail-menu">
            ...
            foreach ($message_threads as $row):
                ...
                <li class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?sadmin/message/message_read/<?php echo $row['message_thread_code']; ?>" style="padding:12px;">
                        <i class="entypo-dot"></i>

                        <?php echo $this->db->get_where('sadmin', array('sadmin_id' => $user_to_show_id))->row()->name; ?>
