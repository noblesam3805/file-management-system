...
<div class="row">
	<div class="col-md-12">
		<?php  echo form_open('sadmin/processSchoolPayments', array('class' => 'form-groups-bordered validate','target'=>'_top'));  ?>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      ...
                      <select name="ptype" class="form-control">
                                <option value="1"><?php echo get_phrase('ACCEPTANCE FEES'); ?></option>
								<option value="2"><?php echo get_phrase('SCHOOL FEES'); ?></option>
								<option value="3"><?php echo get_phrase('TEDC'); ?></option>
								<option value="4"><?php echo get_phrase('TRANSCRIPT FEES'); ?></option>
