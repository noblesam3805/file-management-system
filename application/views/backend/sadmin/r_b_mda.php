...
<form method="post" action="index.php?sadmin/mda_report">


    <div class="form-group col-md-6">
                <label for="field-ta" class=" control-label">Select MDA</label>
                <div class="">
                              <select class="form-control" required name="mda_id">
                              <option value="">Select MDA </option>                                   
                              <?php foreach($faculties as $dept=>$val){ ?>                                 
...
<table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                    <?php $i=1; ?>
                        <?php foreach ($q_r_b_mda as $rep=>$val): ?>
