...
$erp_documents=$this->db->query("select* from erp_documents where (addressed_to_id='$sid' or uploaded_by='$sid' or waiting_approval_by='$sid') and (status='untreated' or status='MINUTED' or status='KIV' or status='AWAITING MINUTING/APPROVAL')")->result_array();
?>
