...
<form method="post" action="index.php?sadmin/age_report">
    ...
    <div class="form-group col-md-6">
                ...
                <p align="left">
					From
						 ...
						 <input type="text" name="from" required class="form-control eduportal-input datepicker"
                          data-start-view="2" placeholder="Present Rank Date"/>
					...
					To
						 <span class="input-group input-group-lg eduportal-input-group">
						 <input type="text" name="to" required class="form-control eduportal-input datepicker"
                          data-start-view="2" placeholder="Present Rank Date"/>
...
<table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                    <?php $i=1; ?>
                        <?php foreach ($q_r_b_age as $rep=>$val): ?>
