...
<?php 
	...
	?>
      ...
      <thead style="margin-bottom:50px;">
        <tr bgcolor="#FFFFFF">
          <th width="68"><div  ><span  style="color:#000">cadre Name</span></div></th>
     <th width="61" align=""><div align="" class="style6"><span class="style4" style="color:#000">Action</span></div></th>		
      ...
      <td><button
       data-toggle="modal" data-target="#<?php echo $cadre['ID']; ?>"
       class="btn btn-warning" style="margin-top:10px">Edit</button>
      <a href="index.php?sadmin/d_cadre/<?php echo $cadre['ID']; ?>" class="btn btn-danger" style="margin-top:10px">
      Delete</a>
      </td>
      </tr>
      <!-- Modal -->
<div id="<?php echo $cadre['ID']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edit Selected Cadre</h4>
      </div>
      <div class="modal-body">
        <form method="post" action="index.php?sadmin/u_cadre/<?php echo $cadre['ID']; ?>">
            <label style="margin-top:10px">Cadre</label>
            <input type="text" class="form-control" value="<?php echo $cadre['Name']; ?>" name="cadre">
