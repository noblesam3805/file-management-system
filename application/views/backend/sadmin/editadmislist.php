...
$program_detailed = $this->db->query("select *  from program_detailed order by 	program_id");

$program_detailed_name =  $this->db->query("select *  from program_detailed where program_id='".$admlist_details->program_id."'")->row()->program_name;
					 ...
					 <p align="left">
                      Program Details
                       <select  name="program_id" id="program_id" class="form-select required"  ">
					    <option value="<?php  echo $admlist_details->program_id;?>" selected="selected"><?php  echo $program_detailed_name;?></option>
					   <option value=""  >- Select -</option>
<?php foreach($program_detailed->result() as $row)
	{
