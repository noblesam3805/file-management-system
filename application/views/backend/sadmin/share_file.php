			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                    ...
                    foreach($file_details as $row):
                      ...
                      SHARE FILE WITH ANOTHER OFFICIAL</b></span>
                                </div><br/>
					  </form> 
					  <?php echo form_open('sadmin/filedms/PROCESS_SHARE_FILE' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top','enctype'=>'multipart/form-data'));?>
                 
               					
	
								
				<div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Official\'s_MDA');?></label>
							 <div class="col-sm-5">
...
<?php 
	...
	?>
								...
								<div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Official\'s Department/Unit');?></label>
                                <div class="col-sm-5">
																			  <span id="dept">
					  ...
					  <option value=""  onChange="">- Select -</option>
							 ...
							 <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Official\'s Name');?></label>
                                <div class="col-sm-5">
									<span id="staff_area">
                      <select  name="sid" id="sid" class="form-control"><option value="" selected="selected" >- Select Staff-</option>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
									<select  name="status" id="status" class="form-control" required ><option value="" selected="selected" >- Select -</option>
					
					<option value="SHARED">SHARE FILE</option>
							...
							<div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
								<button type="submit" class="btn btn-info"><?php echo get_phrase('Share File');?></button>
