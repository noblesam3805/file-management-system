		...
		<ul class="nav nav-tabs bordered">
			...
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-user"></i> 
					<?php echo get_phrase('edit_trash_memo');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------->
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                    ...
                    foreach($edit_memo_detail as $row_memo):
                        ...
                        <?php echo form_open('sadmin/memos/PROCESS_EDIT_TRASH_MEMO' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top','enctype'=>'multipart/form-data'));?>
...
<?php 
	...
	?>
                        ...
                        View Previous Attached Document
                    </a>
                                </div>
                            </div>
												  <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('upload new memo file');?></label>
                                <div class="col-sm-5">
