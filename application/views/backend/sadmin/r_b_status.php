...
<form method="post" action="index.php?sadmin/status_report">

<div class="form-group col-md-6" >
                <label for="field-ta" class=" control-label">Select Status(employment type)</label>
                <div class="">
...
<table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                    <?php $i=1; ?>
                        <?php foreach ($r_b_status as $rep=>$val): ?>
