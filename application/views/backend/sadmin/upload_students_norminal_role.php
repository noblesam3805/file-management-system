		...
		<ul class="nav nav-tabs bordered">
			...
			<li  class="active">
            	...
            	<a href="#manage" data-toggle="tab"><i class="entypo-menu"></i>
					...
					<?php echo "Upload students norminal role";?>
		...
		<div class="widget stacked widget-table">
			...
			<div style="margin-left:30px">
			  ...
			  <p><div style="width:100%; height:100%" align="center">
                  <form id="imageform2" name="imageform2"  method="post" enctype="multipart/form-data" action='index.php?sadmin/ajax_upload_norminalrole' onsubmit="" >
                      <p align="left">
                      Student Type
...
<?php 
	...
	?>
					   ...
					   <p>
                        <input type="file" id="photoimgnorminalrole" name="photoimgnorminalrole" style="width: 228px" class="form-control eduportal-input required" />
                      </p>
 ...
 <th width="157" align="center"><div align="center" class="style6"><span class="style4" style="color:#000">SURNAME</span></div></th>
  <th width="157" align="center"><div align="center" class="style6"><span class="style4" style="color:#000">OTHERNAMES</span></div></th>
