...
<div class="row">
	<div class="col-md-12">
		<?php  echo form_open('sadmin/student_payment_history', array('class' => 'form-groups-bordered validate','target'=>'_top'));  ?>
			...
			<div class="form-group eduportal-form-group p20">
				...
				<br/>
                 <div class="form-group">
                    <label for="field-1" class="col-sm-5 control-label"><?php echo get_phrase("Enter Student's Matric No."); ?></label>

                    <div class="col-sm-12">
					    <div class="input-group">
                     <input type="text" name="matric" value="" class="form-group eduportal-form-group p20"/>
							 </div>
                    </div>
                </div>
