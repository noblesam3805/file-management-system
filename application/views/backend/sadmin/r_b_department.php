...
<form method="post" action="index.php?sadmin/department_report">


    <div class="form-group col-md-6">
                <label for="field-ta" class=" control-label">Select Grade(department)</label>
                <div class="">
                              <select class="form-control" required name="deptID">
                              <option value="">Select Grade </option>                                   
                              <?php foreach($depts as $dept=>$val){ ?>                                 
...
<table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                    <?php $i=1; ?>
                        <?php foreach ($q_r_b_deptID as $rep=>$val): ?>
