...
if( !$student_attachment_info){	
								?>
				<a href="index.php?sadmin/attach_student_xray_results/<?php echo $row["id"];?>" class="btn btn-success btn-sm " >
                       Attach X-Ray<br/> Result/Reports
</a> <?php } else {?><a href="index.php?sadmin/attach_student_xray_results/<?php echo $row["id"];?>" class="btn btn-success btn-sm " >
                      View<br/>/ Change Reports
</a><?php }?>
							</td>
