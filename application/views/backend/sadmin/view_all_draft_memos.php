...
$memodata=$this->db->get_where ('erp_memo_act',array('memo_status'=>'DRAFT','memo_initiator_sid'=>$sid,'initiator_dept_id'=>$dept_id,'initiator_desig_id'=> $desig_id))->result_array();
?>
<script type="text/javascript">
function checkdel()

{
var check = confirm("Do you want to delete memo from draft list?");
if(check==true)
{
                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td> <a href="index.php?sadmin/memos/EDIT_DRAFT_MEMO/<?php echo $row['id'];?>" class="btn btn-primary btn-sm ">
                        Edit| 
						<a href="index.php?sadmin/memos/TRASH_DRAFT/MEMO/<?php echo $row['id'];?>" class="btn btn-success btn-sm "  onclick="checkdel()">
                         Send to Trash  </a>
							</td>
                            <?php $i++;?>
