...
class Crud_model extends CI_Model {
	...
	function get_image_url($type = '' , $id = '')
	{
			...
			$image_url	=	base_url().'uploads/staff_images/'.$id.'.jpg';
		

		return $image_url;
	}

    function get_sign_url($type = '' , $id = '')
	{
		if(file_exists('uploads/'.$type.'_signature/'.$id.'.jpg'))
			$image_url	=	base_url().'uploads/'.$type.'_signature/'.$id.'.jpg';
		else
    ...
    function send_new_private_message() {
        ...
        $sender     =  'sadmin-' . $this->session->userdata('sadmin_id');
    ...
    function get_reciever($message_thread_code, $sender){
        $actor = $this->db->get_where('message_thread', array('message_thread_code' => $message_thread_code))->row();
        if ($sender == $actor->sender)
        {
            $reciever = $actor->reciever;
        }
        else
        {
            $reciever = $actor->sender;
        }
        return $reciever;
    }
    ...
    function send_reply_message($message_thread_code) {
        ...
        $data_message['sender']                 = $sender;
        $data_message['timestamp']              = $timestamp;
        $data_message['reciever']              = $this->crud_model->get_reciever($message_thread_code, $sender);
        $this->db->insert('message', $data_message);
    }
