...
include 'includes/remita_constants_putme.php';
include 'kee.php';
...
//if($_SERVER['HTTP_REFERER'] =="http://45.34.15.68/apis/yabatech/getappformdata.php")
if($_SERVER['HTTP_REFERER'] =="https://erp.yabatech.edu.ng/portal/apis/yabatech/getappformdata.php")
{
$totalAmount = $amt;
...
$beneficiaryAccount2="2031021429";
//$beneficiaryAccount3="4017904612";
$bankCode="000";
$bankCode2="011";
//$bankCode3="070";
$beneficiaryAmount =2000-0;
...
//curl_setopt($curl, CURLOPT_CAINFO, dirname("C:\php\etc\ssl") . '/cacert.pem');
//curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, false);
